...
<!--         	object 태그는 html5에 도입되었다!! iframe, embed가 막혀도 이용 가능! -->
        ...
        <div class="selectBtnDiv" align="center">
            ...
            <input type="button" value="i3" class="btnSize btn-success" onclick="getList('cpu','i3')">
            <input type="button" value="i5" class="btnSize btn-success" onclick="getList('cpu','i5')">
            <input type="button" value="i7" class="btnSize btn-success" onclick="getList('cpu','i7')">
            <br><br>
